...
import PVDConcealerForm, {
  PVDConcealerFormProps,
} from '../../../components/image/pvd/PVDConcealerForm';
...
const PVDConcealer: FunctionComponent = () => {
  ...
  >(async data => {
    ...
    const outputImage = await pvdWorkerClient.encode({
  ...
  return (
    <Page size="md" title="Image - PVD - Conceal">
      <PVDConcealerForm onChange={handleChange} />
      <Box mt={3}>
